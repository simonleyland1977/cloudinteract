...
export default function ManagedAmazonConnectPage() {
    return (
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-3 gap-6 max-w-3xl mx-auto mb-10">
                            ...
                            <div className="bg-slate-900/50 backdrop-blur-sm rounded-xl p-4 border border-slate-800">
                                <div className="text-2xl md:text-3xl font-bold text-indigo-400 mb-1">10-1000+</div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-slate-300 max-w-3xl mx-auto">
                            Three powerful reasons to let us handle your contact center
                        </p>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700 hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20">
                            ...
                            <p className="text-slate-300">
                                From 10 to 10,000 agents instantly. No hardware constraints, no capacity planning headaches.
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="space-y-6">
                                <div>
                                    <div className="flex justify-between items-baseline mb-2">
                                        ...
                                        <span className="text-2xl font-bold text-white">$1k-$2k</span>
                                    </div>
                                ...
                                <div className="pt-4 border-t border-slate-700">
                                    ...
                                    <ul className="space-y-2 text-sm">
                                        <li className="flex justify-between">
                                            ...
                                            <span className="text-white">~$0.02/min</span>
                                        </li>
                                        <li className="flex justify-between">
                                            <span className="text-slate-400">Chat</span>
                                            <span className="text-white">$0.004/msg</span>
                                        </li>
                                        <li className="flex justify-between">
                                            <span className="text-slate-400">SMS</span>
                                            <span className="text-white">$0.01/msg +fees</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
