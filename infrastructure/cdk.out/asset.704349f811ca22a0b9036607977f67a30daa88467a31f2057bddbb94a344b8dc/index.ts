...
const dynamoClient = new DynamoDBClient({ region: BEDROCK_REGION });
...
async function getConversationContext(contactId: string): Promise<ConversationContext> {
    try {
...
async function saveConversationContext(contactId: string, context: ConversationContext): Promise<void> {
...
async function logInteractionToS3(contactId: string, logData: any): Promise<void> {
